...
#
# age = int(input("Будь ласка, вкажіть свій вік: "))
# if age <= 7:
...
# else:
#         print("Гарного перегляду!")


# # Задача 2
# # Текстова в чому різниця між is та ==?
# # Оператор == порівнює значення або рівність двох об’єктів і чи рівні значення у двох змінних
# value_1 = 77777
# value_2 = 77777
# print(value_1 == value_2)    # True
#
# # Оператор is перевіряє, чи дві змінні вказують на той самий об’єкт у пам’яті
# # Відкрити термінал
# #>>> value_1 = 77777
# #>>> value_2 = 77777
...
# # тип інт
# test_1 = input("ведіть перше значення: ")
# test_2 = input("ведіть друге значення: ")
# result = test_1 + test_2
# result_1 = int(result) * 3
# print(type(result_1))
# print(result_1)
# # тип стрінг
# text_1 = input("ведіть перше значення: ")
# text_2 = input("ведіть друге значення: ")
# text = (text_1 + text_2) * 3
# print(type(text))
# print(text)
