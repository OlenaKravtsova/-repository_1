...
from Hellel.October_2023_Home.Home_work_24.widgest.components import Button
...
class PageButtons():
    ...
    def __init__(self, driver: WebDriver):
        ...
        self.button_dynamic_id_click_loc = (By.XPATH, '//button[.="Click Me"]')
    ...
    def button_dynamic_id_click(self):
        return Button(self.driver, self.button_dynamic_id_click_loc)
