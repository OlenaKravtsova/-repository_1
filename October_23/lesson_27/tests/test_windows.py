...
from Hellel.October_23.lesson_25.src.pages.page_windows import WindowPage
from Hellel.October_23.lesson_25.data_for_test import text_for_window_message as expected_text
