...
# staticmethod - зробити з метода звичайну функцію (використовується декоратор)
# classmethod - працювати з обєктом класа (використовується декоратор)
