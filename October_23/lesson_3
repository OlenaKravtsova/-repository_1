...
# or (це додавання),  and (це множення)
...
import decimal  # (бібліотека) імпортування нового типу даних який працює з флоат без помилок
# a = 0.0001  + 0.0002
# # print(a)  # 0.00030000000000000003
# a = round(a, 5)  # 0.0003  кількість знаків після коми до округлення. 5 - це скільки вивести цифер
# print(a)

# in str - дозволяє знайти літеру чи цифру в рядку
...
# strip, lstrip, rstrip - це методи, які обрізає і зберігає змінену стрічку (без +)
# my_string = "+++ abc +++ fdfds +++"
...
# print(string_a[0])         #П
# print(string_a[4])         #і
# print(string_a[0:4])       #Први
# print(string_a[0:index_1]) #Првиіт, як
# print(string_a[:10])       #Првиіт, як
# print(string_a[10:])       # справи? як твій день?
# print(string_a[:])         #Првиіт, як справи? як твій день?
# print(string_a[:1000])     #Првиіт, як справи? як твій день?
# print(string_a[-5:-1])     #день
# print(string_a[-5:])       #день?
# print(string_a[-0:4])      #Први
# print(string_a[::2])       #Пві,я паи кті еь
# print(string_a[len(string_a )//2 + 4:])  #к твій день?
# print(string_a[len(string_a)//2:])      #и? як твій день?
...
# print(list_b[-1][1])
# print(list_b[-1][1] + 300)

# list_a = [23,45,656]
# list_b = list_a  # print(id(list_a), id(list_b), sep="\n", end="\nце все\n")
#
# print(list_a)
# print(list_b)
# list_b.append(100)
